...
const TRANSLATIONS: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    miniCardUseRecentWorkout: 'Use recent workout',
    miniCardUseRecentWorkoutSubtitle: 'Use recent workout',
  ...
  es: {
    ...
    miniCardUseRecentWorkout: 'Usar entrenamiento reciente',
    miniCardUseRecentWorkoutSubtitle: 'Usar entrenamiento reciente',
