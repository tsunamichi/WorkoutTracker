...
export const TEMPLATES: TemplateCard[] = [
  {
    id: 'full_body',
    name: 'Full Body',
    description: 'Train all major muscle groups each session. Great for beginners or those with limited time.',
  ...
  },
  {
    ...
    description: 'Alternate between upper and lower body workouts. Classic and effective split.',
  ...
  },
  {
    id: 'ppl',
    name: 'Push/Pull/Legs',
    description: 'Separate pushing, pulling, and leg exercises. Popular for hypertrophy.',
  ...
  },
  {
    id: 'bro_split',
    name: 'Bro Split',
    description: 'One muscle group per day. Traditional bodybuilding approach.',
  ...
  },
  {
    ...
    description: 'Focus on the big compound lifts with progressive overload. Build raw strength.',
  ...
  },
  {
    id: 'powerbuilding',
    name: 'Powerbuilding',
    description: 'Combine strength and hypertrophy training. Best of both worlds.',
  ...
  },
  {
    id: 'hybrid',
    name: 'Hybrid Athlete',
    description: 'Mix strength training with conditioning. For well-rounded fitness.',
